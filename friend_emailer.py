...
for user in to_send:
    ...
    if (not strTo=='') and (numFriends > 0):
        ...
        msgText = MIMEText(str(numFriends) + ' of your friends ' + word + ' joined drippr in the last 3 days. visit drippr.me to welcome your ' + word2 + ' with some interesting dripps or by adding your ' + word2 + ' to your favorite groups')
